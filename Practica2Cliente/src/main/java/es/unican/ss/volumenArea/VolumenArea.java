 ...
 * 
 */
@WebServiceClient(name = "VolumenArea", targetNamespace = "http://www.unican.es/ss/VolumenArea/", wsdlLocation = "http://localhost:8080/VolumenArea?wsdl")
...
extends Service
{
	...
	static {
		...
		try {
			url = new URL("http://localhost:8080/VolumenArea?wsdl");
